...
def simulation(mapdl: launch_mapdl , 
               bool_inner = True,
               bool_stair = True,
               bool_SSI   = True,
               elem_size  = 0.4,
    ...
    if bool_show_setting_info:
        ...
        print("     Building inner wall           : " ,bool_inner )
        print("     Building stair                : " ,bool_stair ) 
        print("     Building SSI                  : " ,bool_SSI   ) 
        print("     Element size                  : " ,elem_size  ) 
        print("     Solution type                 : " ,Solu_type  )
        print("     Start frequency               : " ,Star_Freq  )
        print("     End frequency                 : " ,End_Freq   )
        print("     Freqency increment            : " ,Freq_Incr  )
        print("     Number of modes (solu_type=2) : " ,N_modes    )
        print("     Height of building            : " ,height     )
        print("     Damping ratio                 : " ,Damping_ratio)
        print("     Excitation_node               : " ,excitation_node)

    if Solu_type == 5 or Solu_type == 6:
    ...
    if nu_arr is None:
        ...
        nu_slab         = nu_arr[0]  
        nu_corridor     = nu_arr[1]
        nu_ground       = nu_arr[2]
        nu_edge_wall    = nu_arr[3]
        nu_inner_wall   = nu_arr[4]
        nu_stair        = nu_arr[5]      
    ...
    if rho_arr is None:
        ...
        rho_slab        = rho_arr[0]
        rho_corridor    = rho_arr[1]
        rho_ground      = rho_arr[2]
        rho_edge_wall   = rho_arr[3]
        rho_inner_wall  = rho_arr[4]
        rho_stair       = rho_arr[5]   
    ...
    solu_time = time.time()
    print(f"     /SOLU finished, duration {solu_time - prep_time:.4f} seconds.")
    ...
    post_time = time.time()
    print(f"     /POST26 finished, duration {post_time -solu_time:.4f} seconds.")
...
def build_model(mapdl:launch_mapdl,
               bool_inner = True,
               bool_stair = True,
               bool_SSI   = True,
               elem_size  = 0.4,
...
def solve_model(mapdl:launch_mapdl,
                bool_SSI   = True,
                height     = 3.37,
                Solu_type  = 3,
                Star_Freq  = 0.001,
...
def get_result(mapdl:launch_mapdl,
               height     = 3.37,
               Star_Freq  = 0.001,
               End_Freq   = 100,
               Freq_Incr  = 0.4):
