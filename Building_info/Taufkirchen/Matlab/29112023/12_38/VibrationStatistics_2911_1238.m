...
%% Data Import
load BP_291123_1238.mat  %UPDATE
load OG1_291123_1238.mat %UPDATE
load OG2_291123_1238.mat %UPDATE
% load \\nas.ads.mwn.de\tubv\bma\GAB\Monitoring\Taufkirchen\Matlab\29112023\12_38\BP_291123_1238.mat  %UPDATE
% load \\nas.ads.mwn.de\tubv\bma\GAB\Monitoring\Taufkirchen\Matlab\29112023\12_38\OG1_291123_1238.mat %UPDATE
% load \\nas.ads.mwn.de\tubv\bma\GAB\Monitoring\Taufkirchen\Matlab\29112023\12_38\OG2_291123_1238.mat %UPDATE


t1=36.062;          %Measurement start          %UPDATE
t2=51.471;          %Measurement end            %UPDATE
T1=39.5;            %Sampling start             %UPDATE
T2=45.5;            %Sampling end               %UPDATE
delta_t=0.001;      %Timestep of sensor
t=t1:0.001:t2;
T_samp=T1:0.001:T2;
index1=3439;        %first index of the sampling time T1 from Excel     %UPDATE
index2=9439;        %last index of the sampling time T2 from Excel      %UPDATE
...
V_X_BP=table2array(BP_291123_1238(:,2));            %UPDATE
...
V_Y_BP=table2array(BP_291123_1238(:,3));            %UPDATE
...
V_Z_BP=table2array(BP_291123_1238(:,4));            %UPDATE
...
V_X_OG1=table2array(OG1_291123_1238(:,2));          %UPDATE
...
V_Y_OG1=table2array(OG1_291123_1238(:,3));          %UPDATE
...
V_Z_OG1=table2array(OG1_291123_1238(:,4));          %UPDATE
...
V_X_OG2=table2array(OG2_291123_1238(:,2));          %UPDATE
...
V_Y_OG2=table2array(OG2_291123_1238(:,3));          %UPDATE
...
V_Z_OG2=table2array(OG2_291123_1238(:,4));          %UPDATE
...
title('1/3 Octave X-Direction (Sampled Time, poctave)')
xlim([0 50])
hold on
...
title('1/3 Octave Y-Direction (Sampled Time, poctave)')
xlim([0 50])
hold on
...
title('1/3 Octave Z-Direction (Sampled Time, poctave)')
xlim([0 50])
hold on
...
% X-direction
X_L_v_BP_edit=20*log10(abs(X_BP_FFT_V_out(:,2)/v_ref));
X_L_v_OG1_edit=20*log10(abs(X_OG1_FFT_V_out(:,2)/v_ref));
X_L_v_OG2_edit=20*log10(abs(X_OG2_FFT_V_out(:,2)/v_ref));
for i=1:length(cf)
    X_L_v_BP_per_fband{i} = X_L_v_BP_edit(X_BP_FFT_V_out(:, 1) >= fl(i) & X_BP_FFT_V_out(:, 1) < fl(i+1));
    X_L_v_ges_BP(i)=10*log10(sum(10.^(X_L_v_BP_per_fband{i}*0.1)));
    X_L_v_OG1_per_fband{i} = X_L_v_OG1_edit(X_OG1_FFT_V_out(:, 1) >= fl(i) & X_OG1_FFT_V_out(:, 1) < fl(i+1));
    X_L_v_ges_OG1(i)=10*log10(sum(10.^(X_L_v_OG1_per_fband{i}*0.1)));
    X_L_v_OG2_per_fband{i} = X_L_v_OG2_edit(X_OG2_FFT_V_out(:, 1) >= fl(i) & X_OG2_FFT_V_out(:, 1) < fl(i+1));
    X_L_v_ges_OG2(i)=10*log10(sum(10.^(X_L_v_OG2_per_fband{i}*0.1)));
    X_f_per_fband_{i} = X_OG2_FFT_V_out(X_OG2_FFT_V_out(:, 1) >= fl(i) & X_OG2_FFT_V_out(:, 1) < fl(i+1), 1);
end

figure
plot(X_BP_FFT_V_out(:,1),X_L_v_BP_edit,"--",cf,X_L_v_ges_BP,'Color',[0 0.4470 0.7410])
hold on
plot(X_OG1_FFT_V_out(:,1),X_L_v_OG1_edit,"--",cf,X_L_v_ges_OG1,'Color',[0.8500 0.3250 0.0980]);
hold on
plot(X_OG2_FFT_V_out(:,1),X_L_v_OG2_edit,"--",cf,X_L_v_ges_OG2,'Color',[0.9290 0.6940 0.1250]);
xlim([0 30])
legend('BP','BP', '1.OG', '1.OG', '2.OG', '2.OG')
title('1/3 Octave X-Direction (Sampled Time)')
xlabel('Frequency [Hz]')
ylabel('L_v [re. 5e-8]')

% z-direction
Y_L_v_BP_edit=20*log10(abs(Y_BP_FFT_V_out(:,2)/v_ref));
Y_L_v_OG1_edit=20*log10(abs(Y_OG1_FFT_V_out(:,2)/v_ref));
Y_L_v_OG2_edit=20*log10(abs(Y_OG2_FFT_V_out(:,2)/v_ref));
for i=1:length(cf)
    Y_L_v_BP_per_fband{i} = Y_L_v_BP_edit(Y_BP_FFT_V_out(:, 1) >= fl(i) & Y_BP_FFT_V_out(:, 1) < fl(i+1));
    Y_L_v_ges_BP(i)=10*log10(sum(10.^(Y_L_v_BP_per_fband{i}*0.1)));
    Y_L_v_OG1_per_fband{i} = Y_L_v_OG1_edit(Y_OG1_FFT_V_out(:, 1) >= fl(i) & Y_OG1_FFT_V_out(:, 1) < fl(i+1));
    Y_L_v_ges_OG1(i)=10*log10(sum(10.^(Y_L_v_OG1_per_fband{i}*0.1)));
    Y_L_v_OG2_per_fband{i} = Y_L_v_OG2_edit(Y_OG2_FFT_V_out(:, 1) >= fl(i) & Y_OG2_FFT_V_out(:, 1) < fl(i+1));
    Y_L_v_ges_OG2(i)=10*log10(sum(10.^(Y_L_v_OG2_per_fband{i}*0.1)));
    Y_f_per_fband_{i} = Y_OG2_FFT_V_out(Y_OG2_FFT_V_out(:, 1) >= fl(i) & Y_OG2_FFT_V_out(:, 1) < fl(i+1), 1);
end

figure
plot(Y_BP_FFT_V_out(:,1),Y_L_v_BP_edit,"--",cf,Y_L_v_ges_BP,'Color',[0 0.4470 0.7410])
hold on
plot(Y_OG1_FFT_V_out(:,1),Y_L_v_OG1_edit,"--",cf,Y_L_v_ges_OG1,'Color',[0.8500 0.3250 0.0980]);
hold on
plot(Y_OG2_FFT_V_out(:,1),Y_L_v_OG2_edit,"--",cf,Y_L_v_ges_OG2,'Color',[0.9290 0.6940 0.1250]);
xlim([0 30])
legend('BP','BP', '1.OG', '1.OG', '2.OG', '2.OG')
title('1/3 Octave Y-Direction (Sampled Time)')
xlabel('Frequency [Hz]')
ylabel('L_v [re. 5e-8]')

% z-direction
Z_L_v_BP_edit=20*log10(abs(Z_BP_FFT_V_out(:,2)/v_ref));
Z_L_v_OG1_edit=20*log10(abs(Z_OG1_FFT_V_out(:,2)/v_ref));
Z_L_v_OG2_edit=20*log10(abs(Z_OG2_FFT_V_out(:,2)/v_ref));
for i=1:length(cf)
    Z_L_v_BP_per_fband{i} = Z_L_v_BP_edit(Z_BP_FFT_V_out(:, 1) >= fl(i) & Z_BP_FFT_V_out(:, 1) < fl(i+1));
    Z_L_v_ges_BP(i)=10*log10(sum(10.^(Z_L_v_BP_per_fband{i}*0.1)));
    Z_L_v_OG1_per_fband{i} = Z_L_v_OG1_edit(Z_OG1_FFT_V_out(:, 1) >= fl(i) & Z_OG1_FFT_V_out(:, 1) < fl(i+1));
    Z_L_v_ges_OG1(i)=10*log10(sum(10.^(Z_L_v_OG1_per_fband{i}*0.1)));
    Z_L_v_OG2_per_fband{i} = Z_L_v_OG2_edit(Z_OG2_FFT_V_out(:, 1) >= fl(i) & Z_OG2_FFT_V_out(:, 1) < fl(i+1));
    Z_L_v_ges_OG2(i)=10*log10(sum(10.^(Z_L_v_OG2_per_fband{i}*0.1)));
    Z_f_per_fband_{i} = Z_OG2_FFT_V_out(Z_OG2_FFT_V_out(:, 1) >= fl(i) & Z_OG2_FFT_V_out(:, 1) < fl(i+1), 1);
end

figure
plot(Z_BP_FFT_V_out(:,1),Z_L_v_BP_edit,"--",cf,Z_L_v_ges_BP,'Color',[0 0.4470 0.7410])
hold on
plot(Z_OG1_FFT_V_out(:,1),Z_L_v_OG1_edit,"--",cf,Z_L_v_ges_OG1,'Color',[0.8500 0.3250 0.0980]);
hold on
plot(Z_OG2_FFT_V_out(:,1),Z_L_v_OG2_edit,"--",cf,Z_L_v_ges_OG2,'Color',[0.9290 0.6940 0.1250]);
xlim([0 30])
legend('BP','BP', '1.OG', '1.OG', '2.OG', '2.OG')
