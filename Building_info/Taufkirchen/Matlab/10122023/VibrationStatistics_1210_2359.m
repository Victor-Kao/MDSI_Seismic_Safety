...
%% Data Import
load \\nas.ads.mwn.de\tubv\bma\GAB\Monitoring\Taufkirchen\Matlab\10122023\BP_101223_2359.mat  %UPDATE
load \\nas.ads.mwn.de\tubv\bma\GAB\Monitoring\Taufkirchen\Matlab\10122023\OG1_101223_2359.mat %UPDATE
load \\nas.ads.mwn.de\tubv\bma\GAB\Monitoring\Taufkirchen\Matlab\10122023\OG2_101223_2359.mat %UPDATE


t1=54.793;          %Measurement start          %UPDATE
t2=10.271+60;       %Measurement end            %UPDATE
T1=59;              %Sampling start             %UPDATE
T2=63;              %Sampling end               %UPDATE
delta_t=0.001;      %Timestep of sensor
t=t1:0.001:t2;
T_samp=T1:0.001:T2;
index1=round(1+(T1-t1)/delta_t);    %first index of the sampling time T1
index2=round(1+(T2-t1)/delta_t);    %last index of the sampling time T2
...
V_X_BP=table2array(BP_101223_2359(:,2));            %UPDATE
V_X_BP_samp(:,1)=T_samp;
V_X_BP_samp(:,2)=V_X_BP(index1:index2);             %Cut Input to sample time
[DSW, V_X_BP_samp(:,2), DSWB] = DeNoising(flag,V_X_BP_samp(:,2),1,'sym8',n1,'sym8',n2,delta_t);

V_Y_BP=table2array(BP_101223_2359(:,3));            %UPDATE
...
V_Z_BP=table2array(BP_101223_2359(:,4));            %UPDATE
...
V_X_OG1=table2array(OG1_101223_2359(:,2));          %UPDATE
...
V_Y_OG1=table2array(OG1_101223_2359(:,3));          %UPDATE
...
V_Z_OG1=table2array(OG1_101223_2359(:,4));          %UPDATE
...
V_X_OG2=table2array(OG2_101223_2359(:,2));          %UPDATE
...
V_Y_OG2=table2array(OG2_101223_2359(:,3));          %UPDATE
...
V_Z_OG2=table2array(OG2_101223_2359(:,4));          %UPDATE
...
[Y_p_BP_samp,Y_cf_BP_samp]=poctave(V_Y_BP_samp(:,2),Fs,'BandsPerOctave',3);
[Y_p_OG1_samp,Y_cf_OG1_samp]=poctave(V_Y_OG1_samp(:,2),Fs,'BandsPerOctave',3);
[Y_p_OG2_samp,Y_cf_OG2_samp]=poctave(V_Y_OG2_samp(:,2),Fs,'BandsPerOctave',3);

[Z_p_BP_samp,Z_cf_BP_samp]=poctave(V_Z_BP_samp(:,2),Fs,'BandsPerOctave',3);
[Z_p_OG1_samp,Z_cf_OG1_samp]=poctave(V_Z_OG1_samp(:,2),Fs,'BandsPerOctave',3);
[Z_p_OG2_samp,Z_cf_OG2_samp]=poctave(V_Z_OG2_samp(:,2),Fs,'BandsPerOctave',3);
...
%Third Octave Analysis (Full Signal)
...
[Y_p_BP,Y_cf_BP]=poctave(V_Y_BP,Fs,'BandsPerOctave',3);
[Y_p_OG1,Y_cf_OG1]=poctave(V_Y_OG1,Fs,'BandsPerOctave',3);
[Y_p_OG2,Y_cf_OG2]=poctave(V_Y_OG2,Fs,'BandsPerOctave',3);

[Z_p_BP,Z_cf_BP]=poctave(V_Z_BP,Fs,'BandsPerOctave',3);
[Z_p_OG1,Z_cf_OG1]=poctave(V_Z_OG1,Fs,'BandsPerOctave',3);
[Z_p_OG2,Z_cf_OG2]=poctave(V_Z_OG2,Fs,'BandsPerOctave',3);

figure
plot(X_cf_BP,X_p_BP)
title('1/3 Octave X-Direction (Full Signal)')
xlim([0 50])
hold on
...
figure
plot(Y_cf_BP,Y_p_BP)
title('1/3 Octave Y-Direction (Full Signal)')
xlim([0 50])
hold on
...
figure
plot(Z_cf_BP,Z_p_BP)
title('1/3 Octave Z-Direction (Full Signal)')
xlim([0 50])
hold on
