...
%% Data Import
load Data_Processing\Event_Statistics\Velocity\29112023\12_38\BP_291123_1238.mat
load Data_Processing\Event_Statistics\Velocity\29112023\12_38\OG1_291123_1238.mat
load Data_Processing\Event_Statistics\Velocity\29112023\12_38\OG2_291123_1238.mat


t1=36.062;          %Measurement start
t2=51.471;          %Measurement end
T1=39.5;              %Sampling start
T2=45.5;               %Sampling end
delta_t=0.001;      %Timestep of sensor
t=t1:0.001:t2;
T_samp=T1:0.001:T2;
index1=3439;        %first index of the sampling time T1 from Excel
index2=9439;        %last index of the sampling time T2 from Excel
...
V_X_BP=table2array(BP_291123_1238(:,2));
...
V_Y_BP=table2array(BP_291123_1238(:,3));
...
V_Z_BP=table2array(BP_291123_1238(:,4));
...
V_X_OG1=table2array(OG1_291123_1238(:,2));
...
%V_X_OG1_samp(:,2)=lowpass_RG(V_X_OG1_samp(:,2));

V_Y_OG1=table2array(OG1_291123_1238(:,3));
...
V_Z_OG1=table2array(OG1_291123_1238(:,4));
...
V_X_OG2=table2array(OG2_291123_1238(:,2));
...
V_Y_OG2=table2array(OG2_291123_1238(:,3));
...
V_Z_OG2=table2array(OG2_291123_1238(:,4));
...
[p_BP,cf_BP]=poctave(V_X_BP,Fs,'BandsPerOctave',3);
[p_OG1,cf_OG1]=poctave(V_X_OG1,Fs,'BandsPerOctave',3);
[p_OG2,cf_OG2]=poctave(V_X_OG2,Fs,'BandsPerOctave',3);

figure
plot(cf_BP,p_BP)
title('1/3 Octave X-Direction BP')
hold on
plot(cf_OG1,p_OG1)
plot(cf_OG2,p_OG2)
